...
// has the widget already been made ???
        ...
        widgetHelpers = {
            ...
            widgetFactory: function widgetFactory() {
                ...
                var widget = widgetList[idx] = new Widget(idx);
                widget.ko = new PensionViewModel();
                return widget;
            },
    ...
    function placeWidget(widget) {
        ...
        setTimeout(function () {
            ...
            $nwd.css('left', 10 + widget.idx * 3);
            $nwd.css('top', 40 + widget.idx * 3);
